...
import { refreshMyProfile } from "../services/waiterProfileApi"; // /auth/me es genérico, sirve para cualquier rol
...
export default function useKitchenProfile() {
  ...
  const onRefresh = useCallback(async () => {
    try {
      ...
      console.error("useKitchenProfile.onRefresh:", err);
